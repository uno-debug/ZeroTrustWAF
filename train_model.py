...
def extract_features(request_string):
    ...
    # First, decode the string to handle URL encoding like %20 and %27
...
# Apply the feature extraction to the decoded request data
...
print("✅ 6. New model saved successfully!")